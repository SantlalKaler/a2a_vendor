...
Fssi fssiFromJson(String str) => Fssi.fromJson(json.decode(str));
String fssiToJson(Fssi data) => json.encode(data.toJson());
class Fssi {
  Fssi({
    String? fieldname,
    String? originalname,
  ...
  String? _etag;
  dynamic _versionId;
  Fssi copyWith({  String? fieldname,
    String? originalname,
    String? encoding,
    String? mimetype,
    num? size,
    ...
    String? etag,
    dynamic versionId,
  }) => Fssi(  fieldname: fieldname ?? _fieldname,
