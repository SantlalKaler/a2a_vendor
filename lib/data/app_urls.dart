class AppUrls {
  ...
  static String updateShop = "app/update-shop";
  static String shopGetProfile = "app/shop-get-profile";
  static String shopGetOrders = "app/shop-get-orders";
  static String settings = "app/settings";
  static String stateList = "app/state-list";
  static String cityList = "app/city-list-by-state";
  static String zipList = "app/zipcode-by-city";
